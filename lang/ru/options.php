...
$MESS['UNITPAY_desc'] = 'Описание заказа';
$MESS['UNITPAY_curr'] = 'Валюта';
...
$MESS['UNITPAY_D_desc'] = 'Например "Оплата заказа из магазина Цветов"';
$MESS['UNITPAY_D_curr'] = 'Валюта, в которой выставляется сумма к оплате';
$MESS['UNITPAY_D_lang'] = '';
...
$MESS['SALE_PARAM'] = 'Настройки для сайта';
